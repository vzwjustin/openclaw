export type ThemeName = "claw" | "knot" | "dash" | "breeze";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["claw", "knot", "dash", "breeze"]);
...
export function resolveTheme(theme: ThemeName, mode: ThemeMode): ResolvedTheme {
  ...
  if (theme === "breeze") {
    return resolvedMode === "light" ? "breeze-light" : "breeze";
  }
